...
const images = [{
  url: 'https://cdn-images-1.medium.com/fit/c/304/312/1*RJoQmQ7L6UZKQ14lYCN6EA.jpeg',
}, {
  url: 'https://cdn-images-1.medium.com/focal/304/312/47/52/1*PQJs-2Fsn3VYM7T8TkaTIA.jpeg',
}, {
  url: 'https://cdn-images-1.medium.com/fit/c/304/312/1*iF8uCp-Dx8BfuCSgkbHvnQ.jpeg',
}];
    ...
    <div className={styles.content}>
      <div className={styles.field}>
        <div className={styles.inputWrapper}>
          <TextareaAutosize className={styles.input} placeholder="Leave a comment..." rows="1" />
        </div>
