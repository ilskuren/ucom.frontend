                    ...
                    <div className="content__section content__section_small" id="question-1">
                      ...
                      >
                        <div className="text_faq">
                          ...
                          <ul>
                            ...
                            <li>Trust — A social transaction with which you extend your web of trust to other accounts: people and <FAQLink name="Organization">Organization</FAQLink></li>
                      ...
                      >
                        <div className="text_faq">
                          ...
                          <p>You can interact with all the content on the platform: like, comment and share posts, sell and purchase goods and services via offers, run and join <FAQLink name="Community">Community</FAQLink> and <FAQLink name="Organization">Organization</FAQLink>.</p>
                      ...
                      >
                        <div className="text_faq">
                          ...
                          <ul>
                            ...
                            <li>
                            Organization profile — you can invite other users of the platform to the Community Board. See also <FAQLink name="Community">DAC</FAQLink>.
                            </li>
                          </ul>
                    ...
                    >
                      <div className="text_faq">
                        ...
                        <ul>
                          ...
                          <li>Account to account transfer — for example by running a <FAQLink name="Organization">Organization</FAQLink></li>
