...
const Publications = (props) => {
  ...
  const onClickLoadMore = () => {
    props.history.push(urls.getPublicationsCategoryUrl(postsCategory.name, +props.match.params.page + 1));
  };
...
export const getPublicationsPageData = (postsCategoryId, page) =>
  feedActions.feedGetPosts(postsCategoryId, { page, perPage: FEED_PER_PAGE });
